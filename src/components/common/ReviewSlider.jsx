...
function ReviewSlider() {
  ...
  return (
    <div className="text-lg">
      <div className="my-[50px] border-2 border-mwhite p-4 h-fitContent max-w-maxContentTab lg:max-w-maxContent">
        <Swiper
        ...
        >
          {reviews.map((review, i) => {
            return (
              <SwiperSlide key={i}>
                <div className="flex flex-col gap-1  bg-richblack-800 rounded-xl p-3 text-[14px] text-black ">
                  ...
                  <p className="font-medium text-black italic p-8 text-center">
