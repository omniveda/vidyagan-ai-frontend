      ...
      <form onSubmit={handleOnSubmit} className="flex w-full flex-col gap-y-4">
        <div className="flex gap-x-4">
          <label style={{ position: "relative" }}>
            ...
            <input
              ...
              className="w-full border rounded-[0.5rem] bg-richblack-800 p-[12px] text-black-5"
            />
          </label>
          <label style={{ position: "relative" }}>
            <p className="mb-1 text-[0.875rem] leading-[1.375rem] text-black-5">
            ...
            <input
              ...
              className="w-full border rounded-[0.5rem] bg-black-800 p-[12px] text-black-5"
            />
          </label>
        </div>
        ...
        <label className="w-full">
          ...
          <PhoneInput
            ...
            inputClass="w-full bg-transparent p-[23px] text-black outline-none"
          />
        </label>
        ...
        <div className="flex gap-x-4">
          <label style={{ position: "relative" }}>
            ...
            <input
              ...
              className="w-full border rounded-[0.5rem] bg-black-800 p-[12px] pr-10 text-black-5"
            />
            <span
              onClick={() => setShowPassword((prev) => !prev)}
              className="absolute right-3 top-[38px] z-[10] cursor-pointer"
        ...
        <button
          type="submit"
          className="mt-6 rounded-[8px] bg-yellow-50 py-[8px] px-[12px] font-medium text-black-900 hover:bg-blue-200 text-[white]"
        >
          Create Account
        </button>
      </form>
