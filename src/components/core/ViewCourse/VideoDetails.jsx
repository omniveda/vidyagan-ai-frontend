    ...
    <div className="flex flex-col gap-5 text-white">
      {(!videoData || !videoData.videoUrl) ? (
        <div className="flex flex-col items-center justify-center h-96">
          <p className="text-lg text-red-500 font-semibold">Video not available or data not loaded.</p>
          <p className="text-sm text-gray-300 mt-2">Please check your course content or contact support.</p>
        </div>
      ) : (
        <Player
          ref={playerRef}
